...
/// @nodoc
class _$CreateExerciseStateTearOff {
  const _$CreateExerciseStateTearOff();
...
/// @nodoc
// ignore: unused_element
const $CreateExerciseState = _$CreateExerciseStateTearOff();
...
/// @nodoc
abstract class $CreateExerciseStateCopyWith<$Res> {
  factory $CreateExerciseStateCopyWith(
          CreateExerciseState value, $Res Function(CreateExerciseState) then) =
      _$CreateExerciseStateCopyWithImpl<$Res>;
}

/// @nodoc
class _$CreateExerciseStateCopyWithImpl<$Res>
    implements $CreateExerciseStateCopyWith<$Res> {
  _$CreateExerciseStateCopyWithImpl(this._value, this._then);

  final CreateExerciseState _value;
  // ignore: unused_field
...
/// @nodoc
class __$StandardCopyWithImpl<$Res>
    extends _$CreateExerciseStateCopyWithImpl<$Res>
...
class _$_Standard with DiagnosticableTreeMixin implements _Standard {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CreateExerciseState.standard(failed: $failed)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'CreateExerciseState.standard'))
...
abstract class _Standard implements CreateExerciseState {
...
class _$_Submitting with DiagnosticableTreeMixin implements _Submitting {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CreateExerciseState.submitting()';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'CreateExerciseState.submitting'));
  }
...
abstract class _Submitting implements CreateExerciseState {
...
class _$_Success with DiagnosticableTreeMixin implements _Success {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CreateExerciseState.success()';
  }

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties..add(DiagnosticsProperty('type', 'CreateExerciseState.success'));
  }
...
abstract class _Success implements CreateExerciseState {
